...
import $ from 'jquery';
class Search {
  // Step 1: describe create/initiate our object
  constructor() {
    this.addSearchHTML();
  ...
  event() {
    ...
    $(document).on('keydown', this.keyPressDispacter.bind(this));
    this.searchField.on('keyup', this.typingLogic.bind(this));
  }
  // Step 3: methods (functions, verb-like actions...)
  typingLogic() {
  ...
  openOverlay() {
    ...
    // return: false will prevent default behavior of a link elements
    return false;
  }
  closeOverlay() {
