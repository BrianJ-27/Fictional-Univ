...
<header class="site-header">
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url(); ?>"><strong>Zoo</strong> Institute</a></h1>
...
//Worpress function that first looks into your function.php file to activate dynamic menu in WP
    ...
    'theme_location' => 'headerMenuLocation',
            ...
            ?> -->
        <!--how to make the selected link be the selected active color in our css
          for the php code below, if the current page is "about us" or if the current
          pages parent page is the about us page then echo out this class
      -->
          <ul>
